...
public class Drag : MonoBehaviour
{
    ...
    void Update()
    {
        if (isBeingHeld)    //if object is being held
        {
            ...
            gameObject.transform.localPosition = new Vector2(mousePos.x, mousePos.y);   //change position of mousePos 
        }
    }
    ...
    private void OnMouseUp()    //when you let go of the mouse button
    {
